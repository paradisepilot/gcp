...
with models.DAG(JOB_NAME,
    ...
    sum_task_0 = kubernetes_pod.KubernetesPodOperator(
      ...
      # image='gcr.io/gcp-runtimes/ubuntu_18_0_4',
        ...
        cmds=["sh", "-c", "echo;echo \'Sleeping ...\' ; sleep 10 ; echo;echo whoami=`whoami` ; echo;echo \'ls -l /opt/conda/bin/R*\' ; ls -l /opt/conda/bin/R* ; echo;echo \'ls -l /usr/local/bin\' ; ls -l /usr/local/bin ; echo;echo \'ls -l /data\' ; ls -l /data ; echo;echo \'Done!\'"],
